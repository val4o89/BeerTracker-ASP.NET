...
using BeerTracker.Models.ViewModels.Manage;
...
#region Helpers
        ...
        public ActionResult UploadProfilePicture(HttpPostedFileBase file)
        {
            if (file.ContentLength > 0)
            {
                ...
                this.service.UploadProfilePicture(target, file, User.Identity.Name);
            }

            //this.service.UploadProfilePicture(file, User.Identity.Name);
